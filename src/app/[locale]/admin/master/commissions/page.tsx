...
export default function MasterCommissionsPage() {
  const [reports, setReports] = useState([
    { id: 1, shop: 'Safari Camp', volume: 12400, commission: 1240, rate: '10%', status: 'paid' },
    {
      id: 2,
      shop: 'Mountain Retreat',
      volume: 8500,
      commission: 850,
      rate: '10%',
      status: 'pending',
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <RevenueCard title="Total Fees Collected" value="$128,420" trend="+15.2%" color="purple" />
        <RevenueCard title="Pending Payouts" value="$12,850" trend="-2.4%" color="blue" />
        <RevenueCard title="Average Commission" value="10.2%" trend="+0.5%" color="green" />
      </div>
