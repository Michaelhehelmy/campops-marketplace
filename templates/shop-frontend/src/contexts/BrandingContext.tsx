...
const buildTimeDefaults: BrandingConfig = {
  ...
  companyName:
    ...
    "SinaiCamps",
  tagline:
    import.meta.env.VITE_TAGLINE || import.meta.env.VITE_APP_TAGLINE || "Hospitality Management",
  ...
  primaryColor:
    import.meta.env.VITE_PRIMARY_COLOR || import.meta.env.VITE_APP_PRIMARY_COLOR || "#0f172a",
  accentColor:
    import.meta.env.VITE_ACCENT_COLOR ||
    import.meta.env.VITE_SECONDARY_COLOR ||
    import.meta.env.VITE_APP_ACCENT_COLOR ||
    "#0ea5e9",
