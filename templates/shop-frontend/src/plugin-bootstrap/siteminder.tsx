 ...
 * bootstrapSiteMinder
 * ───────────────────
 * Registers SiteMinder components into the global registry.
 */
export function bootstrapSiteMinder() {
  componentRegistry.register("siteminder:SiteMinderStatusWidget", SiteMinderStatusWidget);
}
