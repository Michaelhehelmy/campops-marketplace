...
<｜DSML｜parameter name="TargetFile" string="true">/home/michael/Proj/campops-marketplace/docs/ENHANCEMENT_PLAN.md</｜DSML｜parameter>
<｜DSML｜parameter name="CodeContent" string="true"># CampOps Marketplace — Enhancement Plan
...
CampOps Marketplace is a **well-architected, genuinely generic multi-tenant platform** with a clean core/plugin separation. The framework successfully avoids domain coupling — booking, CRM, loyalty, and resource concepts all live in plugins, not in core. The testing infrastructure is robust (337 unit tests passing, 5 core E2E suites, Page Object Model pattern). The deployment story covers Vercel, Docker, and bare-metal with Caddy.
...
**Key gaps**: Many plugins are stubs or partially implemented. The [PluginAPI](cci:2://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:197:0-269:1) has several no-op stubs (`ui.*`, `services.*`, [plugins.get](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:240:4-240:26), [publish](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:229:2-230:46)/[subscribe](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:231:2-231:69)). Error handling is inconsistent. There is no structured logging, rate limiting, audit trail, or email notification infrastructure. Tier enforcement exists in middleware but is incomplete at the API layer.
...
- **Core schema** (`src/db/schema.ts`) contains only generic tables: `users`, `sessions`, `accounts`, `verifications`, `user_roles`, `available_plugins`, `profiles`, `tenants` (née [properties](cci:9://file:///home/michael/Proj/campops-marketplace/src/app/api/properties:0:0-0:0)), `tenantStaff`, `tenantPlugins`.
- **Plugin tables** are created at runtime via [api.db.createTable()](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:182:2-186:69) with the `plugin_<id>_<name>` prefix convention.
...
**Concern**: The [properties](cci:9://file:///home/michael/Proj/campops-marketplace/src/app/api/properties:0:0-0:0) table still carries hospitality-leaning columns (`price_per_night`, `amenities`, `rating`, `currency_code`). These should migrate to the `resource` plugin's `listings` table, leaving `tenants` truly generic (name, slug, plan, branding, domain).

### 2.2 Plugin API Contract — **Good foundation, incomplete implementation**

The [PluginAPI](cci:2://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:197:0-269:1) interface ([packages/plugin-sdk/src/types.ts](cci:7://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:0:0-0:0)) is well-designed with clear separation: `db`, `hooks`, `services`, `ui`, [auth](cci:9://file:///home/michael/Proj/campops-marketplace/src/app/api/auth:0:0-0:0), [plugins](cci:9://file:///home/michael/Proj/campops-marketplace/docs/plugins:0:0-0:0), `events`. However, the implementation in `src/lib/PluginAPI.ts` has critical gaps:

| API Surface                                                                                                                                                                                                                                      | Status       | Issue                                        |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------ | -------------------------------------------- |
| [ui.registerSlot](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:253:4-254:62) / [addSlotComponent](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:255:4-255:66) | **No-op**    | Does not persist to any registry             |
| [ui.registerMenuItem](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:257:4-258:47) / [addMenuItem](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:259:4-259:42)  | **No-op**    | Same                                         |
| [ui.registerDashboardWidget](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:261:4-262:58)                                                                                                                | **No-op**    | Same                                         |
| [ui.registerSettingsPage](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:265:4-266:60)                                                                                                                   | **No-op**    | Same                                         |
| [services.payment.initiatePayment](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:36:2-41:61)                                                                                                            | **Mock**     | Returns hardcoded URL                        |
| [services.tax.calculateTaxes](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:45:2-51:4)                                                                                                                  | **Mock**     | Returns empty taxes                          |
| [services.notification.send](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:55:2-61:19)                                                                                                                  | **No-op**    | Does nothing                                 |
| [services.i18n.t](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:65:2-65:72)                                                                                                                             | **Identity** | Returns key as-is                            |
| [plugins.get(name)](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:240:4-240:26)                                                                                                                         | **No-op**    | Always returns `null`                        |
| [publish](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:229:2-230:46) / [subscribe](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:231:2-231:69)                | **No-op**    | Console.log only                             |
| `config`                                                                                                                                                                                                                                         | **Empty**    | Not populated from `property_plugins.config` |

These stubs mean that plugin [init()](cci:1://file:///home/michael/Proj/campops-marketplace/plugins/pwa/src/index.ts:10:0-63:1) functions that call [api.ui.addSlotComponent(...)](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:255:4-255:66) appear to work but have no runtime effect. The UI registry (`/api/plugins/ui-registry`) reads slots from the `available_plugins.manifest` JSON column instead — creating a **dual-source-of-truth problem**.
...
- **Auth token detection** checks three cookie names (`campops_token`, `better-auth.session_token`, `better-auth.session-token`) — fragile and should be consolidated.
...
[PluginShell.tsx](cci:7://file:///home/michael/Proj/campops-marketplace/src/app/PluginShell.tsx:0:0-0:0) tries both: it checks `slotManager.getComponent()` first, then falls back to [componentRegistry.get()](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:240:4-240:26). This dual approach creates confusion and maintenance burden. The Single-SPA integration adds complexity (parcel mounting, lifecycle management) without clear benefit since all plugins are React components in the same app.
...
| Plugin lifecycle (init, route registration)             | `PluginRuntimeService`, [PluginAPI](cci:2://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:197:0-269:1) | Working for server-side                 |
...
| Feature                                   | Status                                                                                                           | Gap                                                                                                                                                                         |
| ----------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| CRM activity logging                      | Hook listener works                                                                                              | No UI for viewing activities; [api.db.createTable](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:182:2-186:69) missing `id` column |
...
| Tier enforcement (Basic/Premium/Ultimate) | Middleware checks exist                                                                                          | No API-level enforcement; `PREMIUM_ONLY` only covers [/admin](cci:9://file:///home/michael/Proj/campops-marketplace/src/app/api/admin:0:0-0:0)                              |
...
| White-label branding                      | [branding](cci:9://file:///home/michael/Proj/campops-marketplace/src/app/api/branding:0:0-0:0) column on tenants | No UI to configure; [/api/branding](cci:9://file:///home/michael/Proj/campops-marketplace/src/app/api/branding:0:0-0:0) route exists but untested                           |
...
| Feature                                                         | Evidence                                                                                                                                                     |
| --------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Email notifications (booking confirmations, check-in reminders) | [services.notification.send](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:55:2-61:19) is no-op                     |
...
| Housekeeping, Maintenance, Activities plugins                   | Directories exist but contain only [plugin.json](cci:1://file:///home/michael/Proj/campops-marketplace/plugins/resource/src/routes/index.ts:12:0-18:1) stubs |
| OTA channel manager (SiteMinder, etc.)                          | [OTAAdapter](cci:2://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:135:0-142:1) types defined in SDK but no implementation  |
...
- **TypeScript strict mode** enabled ([tsconfig.json](cci:7://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/tsconfig.json:0:0-0:0)).
- **Consistent plugin [init()](cci:1://file:///home/michael/Proj/campops-marketplace/plugins/pwa/src/index.ts:10:0-63:1) signature**: `export default async function init(api: PluginAPI)`.
- **Zod validation** used in booking and resource plugin routes.
- **Clear file organization**: `src/lib/` for framework, [src/app/api/](cci:9://file:///home/michael/Proj/campops-marketplace/src/app/api:0:0-0:0) for routes, `plugins/<name>/src/` for plugins.
- **Backward-compatibility aliases** in schema ([properties](cci:9://file:///home/michael/Proj/campops-marketplace/src/app/api/properties:0:0-0:0) → `tenants`, `propertyStaff` → `tenantStaff`) with clear deprecation comments.
...
- **[src/lib/guest.ts](cci:7://file:///home/michael/Proj/campops-marketplace/src/lib/guest.ts:0:0-0:0)**: Uses `$1` PostgreSQL placeholders but the codebase primarily uses SQLite.
...
- [src/lib/guest.ts](cci:7://file:///home/michael/Proj/campops-marketplace/src/lib/guest.ts:0:0-0:0): Uses `$1`, `$2` throughout — **will fail on SQLite**.
- [src/lib/featureFlags.ts](cci:7://file:///home/michael/Proj/campops-marketplace/src/lib/featureFlags.ts:0:0-0:0): Uses `$1` — **will fail on SQLite**.
- [plugins/loyalty/src/index.ts](cci:7://file:///home/michael/Proj/campops-marketplace/plugins/loyalty/src/index.ts:0:0-0:0): Uses `$1`, `$2` — **will fail on SQLite**.

The `DrizzleDatabaseWrapper._prepareSql()` converts `$1` → `?` but only when called through `db.prepare()`. Direct calls to [db.query()](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:175:2-176:52), [db.queryOne()](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:177:2-178:53), [db.execute()](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:211:4-211:78) also go through `prepare()` so they should work — but the inconsistency is confusing and error-prone.

#### 4.2.4 Hardcoded Values

- `PluginAPI.ts` line 149: `version: '1.0.0'` — should come from [plugin.json](cci:1://file:///home/michael/Proj/campops-marketplace/plugins/resource/src/routes/index.ts:12:0-18:1) manifest.
- `PluginAPI.ts` line 175: `paymentUrl: 'https://mock-payment.com'` — hardcoded mock.
- [Nav.tsx](cci:7://file:///home/michael/Proj/campops-marketplace/src/components/Nav.tsx:0:0-0:0) line 31: `CampOps` brand name hardcoded — should use tenant branding config.
- `src/app/[locale]/layout.tsx` line 8: `CampOps Marketplace` title hardcoded.
...
- Test setup ([src/test/setup.ts](cci:7://file:///home/michael/Proj/campops-marketplace/src/test/setup.ts:0:0-0:0)) resets DB state via `db.resetMockStore()` after each test.
- Mock API builder pattern documented in [TESTING.md](cci:7://file:///home/michael/Proj/campops-marketplace/TESTING.md:0:0-0:0).
...
- **Page Object Model** pattern used ([CoreProbeApiPage](cci:2://file:///home/michael/Proj/campops-marketplace/e2e/pages/CoreProbeApiPage.ts:7:0-40:1)).
...
| **No static generation for public pages**    | [page.tsx](cci:7://file:///home/michael/Proj/campops-marketplace/src/app/%5Blocale%5D/page.tsx:0:0-0:0) uses `cache: 'no-store'` | Medium   | Use ISR with tenant-aware revalidation                           |
...
- **RBAC** via `user_roles` table with [master](cci:9://file:///home/michael/Proj/campops-marketplace/src/app/api/master:0:0-0:0), `manager`, `staff`, [guest](cci:9://file:///home/michael/Proj/campops-marketplace/src/app/api/guest:0:0-0:0) roles.
- **Tenant isolation** in [ScopedRepository](cci:2://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:25:0-31:1) — all queries are filtered by `property_id`.
- **Middleware auth guards** for [/manage](cci:9://file:///home/michael/Proj/campops-marketplace/src/app/api/manage:0:0-0:0), [/owner](cci:9://file:///home/michael/Proj/campops-marketplace/src/app/api/owner:0:0-0:0), [/admin](cci:9://file:///home/michael/Proj/campops-marketplace/src/app/api/admin:0:0-0:0), [/guest](cci:9://file:///home/michael/Proj/campops-marketplace/src/app/api/guest:0:0-0:0) routes.
- **Staff restrictions** on `/finance`, `/settings`, [/plugins](cci:9://file:///home/michael/Proj/campops-marketplace/docs/plugins:0:0-0:0).
...
| **Cookie-based auth without HttpOnly** | Medium   | `campops_role` cookie is set but may not be HttpOnly                                                            |
...
2. **Fix `$1`/`$2` in [src/lib/guest.ts](cci:7://file:///home/michael/Proj/campops-marketplace/src/lib/guest.ts:0:0-0:0)** — ensure compatibility or mark as PostgreSQL-only.
3. **Fix `$1`/`$2` in [src/lib/featureFlags.ts](cci:7://file:///home/michael/Proj/campops-marketplace/src/lib/featureFlags.ts:0:0-0:0)** — same.
4. **Fix `$1`/`$2` in [plugins/loyalty/src/index.ts](cci:7://file:///home/michael/Proj/campops-marketplace/plugins/loyalty/src/index.ts:0:0-0:0)** — same.
5. **Add missing `id` column to CRM `activities` table** — [createTable](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:182:2-186:69) call has no primary key.
...
9. **Add [PluginAPI](cci:2://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:197:0-269:1) version from manifest** — read [plugin.json](cci:1://file:///home/michael/Proj/campops-marketplace/plugins/resource/src/routes/index.ts:12:0-18:1) instead of hardcoding `'1.0.0'`.
...
- Working [api.plugins.get()](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:240:4-240:26) for inter-plugin communication
...
- Plugin SDK CLI (`create-campops-plugin`)
...
- Create a [Logger](cci:2://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:93:0-98:1) class wrapping `pino` or `winston`
- Support log levels: `trace`, [debug](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:97:2-97:42), [info](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:94:2-94:41), [warn](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:95:2-95:41), [error](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:96:2-96:42)
...
- **Files**: `PluginDiscoveryService.ts`, [guest.ts](cci:7://file:///home/michael/Proj/campops-marketplace/src/lib/guest.ts:0:0-0:0), [featureFlags.ts](cci:7://file:///home/michael/Proj/campops-marketplace/src/lib/featureFlags.ts:0:0-0:0), [plugins/loyalty/src/index.ts](cci:7://file:///home/michael/Proj/campops-marketplace/plugins/loyalty/src/index.ts:0:0-0:0)
...
- Wire [api.ui.registerSlot](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:253:4-254:62), [addSlotComponent](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:255:4-255:66), [registerMenuItem](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:257:4-258:47), [registerDashboardWidget](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:261:4-262:58), [registerSettingsPage](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:265:4-266:60) to the service
- Update `/api/plugins/ui-registry` to read from the registry service (not just `available_plugins.manifest`)
- **Files**: New `src/lib/UIRegistryService.ts`, modify `PluginAPI.ts`, [ui-registry/route.ts](cci:7://file:///home/michael/Proj/campops-marketplace/src/app/api/plugins/ui-registry/route.ts:0:0-0:0)
- **Tests**: Verify slot registration persists and is returned by UI registry API

#### Task 2.2: Implement [api.plugins.get()](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:240:4-240:26)

- Create `PluginBroker` that tracks loaded plugin instances and their returned APIs
- Wire [api.plugins.get(name)](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:240:4-240:26) to return another plugin's public API
...
- Implement [services.notification.send()](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:55:2-61:19) in PluginAPI
...
- Update [PluginShell.tsx](cci:7://file:///home/michael/Proj/campops-marketplace/src/app/PluginShell.tsx:0:0-0:0) to only use `slotManager`
- **Files**: Remove `plugins-init.ts`, modify [PluginShell.tsx](cci:7://file:///home/michael/Proj/campops-marketplace/src/app/PluginShell.tsx:0:0-0:0)
...
- [ ] [api.plugins.get()](cci:1://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:240:4-240:26) works for inter-plugin calls
...
| Plugin               | Directory                       | Status     | Has [plugin.json](cci:1://file:///home/michael/Proj/campops-marketplace/plugins/resource/src/routes/index.ts:12:0-18:1) | Has [init()](cci:1://file:///home/michael/Proj/campops-marketplace/plugins/pwa/src/index.ts:10:0-63:1) | Has Tests |
| -------------------- | ------------------------------- | ---------- | ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ | --------- |
...
| [packages/plugin-sdk/src/types.ts](cci:7://file:///home/michael/Proj/campops-marketplace/packages/plugin-sdk/src/types.ts:0:0-0:0) | 275   | Plugin SDK type definitions                                                                                      |
| [src/app/PluginShell.tsx](cci:7://file:///home/michael/Proj/campops-marketplace/src/app/PluginShell.tsx:0:0-0:0)                   | 103   | Frontend plugin slot renderer                                                                                    |
| `src/app/api/[...path]/route.ts`                                                                                                   | 96    | Catch-all API for plugin routes                                                                                  |
| `src/app/api/p/[...plugin]/route.ts`                                                                                               | 84    | Alternative catch-all for [/api/p/](cci:9://file:///home/michael/Proj/campops-marketplace/src/app/api/p:0:0-0:0) |
| [plugins/booking/src/index.ts](cci:7://file:///home/michael/Proj/campops-marketplace/plugins/booking/src/index.ts:0:0-0:0)         | 138   | Booking plugin entry point                                                                                       |
| [plugins/resource/src/index.ts](cci:7://file:///home/michael/Proj/campops-marketplace/plugins/resource/src/index.ts:0:0-0:0)       | 146   | Resource plugin entry point                                                                                      |
| [plugins/crm/src/index.ts](cci:7://file:///home/michael/Proj/campops-marketplace/plugins/crm/src/index.ts:0:0-0:0)                 | 101   | CRM plugin entry point                                                                                           |
| [plugins/pwa/src/index.ts](cci:7://file:///home/michael/Proj/campops-marketplace/plugins/pwa/src/index.ts:0:0-0:0)                 | 65    | PWA plugin entry point                                                                                           |
| [plugins/loyalty/src/index.ts](cci:7://file:///home/michael/Proj/campops-marketplace/plugins/loyalty/src/index.ts:0:0-0:0)         | 256   | Loyalty plugin entry point                                                                                       |
| [plugins/test-probe/src/index.ts](cci:7://file:///home/michael/Proj/campops-marketplace/plugins/test-probe/src/index.ts:0:0-0:0)   | 106   | Test probe plugin                                                                                                |
