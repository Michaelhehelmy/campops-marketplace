 ...
 */
export declare const UISlots: {
  readonly NAV_MAIN: 'nav.main';
  readonly DASHBOARD_TOP: 'dashboard.top';
  readonly DASHBOARD_MIDDLE: 'dashboard.middle';
  readonly DASHBOARD_BOTTOM: 'dashboard.bottom';
  readonly DASHBOARD_WIDGETS: 'dashboard.widgets';
  readonly ADMIN_SETTINGS_TABS: 'admin.settings.tabs';
  readonly POS_ACTIONS: 'pos.actions';
  readonly HOUSEKEEPING_ROOM_CARD: 'housekeeping.room_card';
  readonly RESERVATION_DETAIL: 'reservation.detail';
  readonly GUEST_DASHBOARD_CARDS: 'guest.dashboard.cards';
  readonly GUEST_BOOKING_DETAIL: 'guest.booking.detail';
  readonly GUEST_PROFILE_SECTIONS: 'guest.profile.sections';
  readonly STAFF_ROSTER_SHIFTS: 'staff.roster.shifts';
  readonly STAFF_TASKS_LIST: 'staff.tasks.list';
  readonly PUBLIC_PROPERTY_HERO: 'public.property_detail.hero';
  readonly PUBLIC_PROPERTY_AMENITIES: 'public.property_detail.amenities';
  readonly PUBLIC_BOOKING_UPSELLS: 'public.booking.upsells';
  readonly PUBLIC_FOOTER_LINKS: 'public.footer.links';
};
